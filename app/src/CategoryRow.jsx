...
import { faUnlock,faLock } from '@fortawesome/free-solid-svg-icons'; // SSL lock icon.
...
`;
    ...
    if (item.discussions) {
      ...
      item.discussions.forEach(discussion => {
        result += '<a href="https://github.com/osmlab/name-suggestion-index/discussions/' + discussion + '" title="View discussion #' + discussion + '">#';
        result += discussion;
        result += '</a><br/>';
      });
    }
